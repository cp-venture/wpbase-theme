...
?>
<!-- article> --> 
<article id="post-<?php the_ID(); ?>" <?php post_class('pos-single ptype-content-video post-article single-post-article'); ?>>
    <?php 
    ...
    <div class="list-single-main-item fl-wrap block_box">
        <?php 
        if( get_post_meta(get_the_ID(),'_cth_show_page_header',true ) != 'yes' || ( get_post_meta(get_the_ID(),'_cth_show_page_header',true ) == 'yes' && get_post_meta(get_the_ID(),'_cth_show_page_title',true ) != 'yes' ) ) the_title( '<h1 class="post-opt-title">', '</h1>' );
