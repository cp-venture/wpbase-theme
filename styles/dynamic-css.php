...
if (!function_exists('zass_add_custom_css')) {
	...
	function zass_add_custom_css() {
		...
		<style media="all" type="text/css">
			...
			?>
			h2, .zass-counter-h2, .zass-typed-h2, .icon_teaser h3:first-child, body.woocommerce-account #customer_login.col2-set .owl-nav, #customer_login.u-columns.col2-set .owl-nav {color:<?php echo esc_attr($h2_font['color']) ?>;font-size:<?php echo esc_attr($h2_font['size']) ?>;<?php echo esc_attr($h2_css_style) ?>}
			/* H3 */
			<?php
